...
class Env():
    def __init__(self,):
        ...
        self.realWorldFlag =  rospy.get_param('/real_world',False)
        self.angScale = 1.0
    ...
    def step(self, action):
        ...
        vel_cmd.angular.z = self.angScale * ang_vel  # change when learing
        ...
        # print("sleep after %f seconds"%self.stepTime)
        vel_cmd = Twist()
